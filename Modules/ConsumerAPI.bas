...
Const Customer_URI_Start As String = "https://apigateway.omamittari.fi/kuluttaja/api/v1.1"
...
strCustomerIdList = Sheets("Consumer API v1.1").Cells(3, 5).Value & "," & Sheets("Consumer API v1.1").Cells(4, 5).Value & "," & Sheets("Consumer API v1.1").Cells(5, 5).Value
...
strJSON = JsonDataFetch(Customer_URI_Start, "asiakkaat?nimi=" & strName)
...
strConsumptionPlaceIdList = Sheets("Consumer API v1.1").Cells(3, 11).Value & "," & Sheets("Consumer API v1.1").Cells(4, 11).Value & "," & Sheets("Consumer API v1.1").Cells(5, 11).Value
